...
#undef minor
    ...
    // Color is the type we use to represent get_lcolor. We can use Color like this:
    ...
    struct Color {
        ...
        Color(Transparency vv) : c(Fl_Color()), v(vv) {}    // default get_lcolor
    ...
    class Shape {        // deals with get_lcolor and style, and holds sequence of lines
    public:
        void draw() const;                 // deal with get_lcolor and draw lines
        virtual void move(int dx, int dy); // move the shape +=dx and +=dy

        void set_color(Color col) { lcolor = col; }

        Color get_lcolor() const { return lcolor; }

        Color get_fcolor() const { return fcolor; }
    ...
    private:
        ...
        Color lcolor;                      // get_lcolor for lines and characters
        Line_style ls;
        Color fcolor;                      // fill get_lcolor
